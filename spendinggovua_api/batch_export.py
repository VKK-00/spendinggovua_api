...
DEFAULT_ARCHIVE_NAME = "forma-2-all-mentioned-edrpou-html.zip"
...
async def export_form2_html_archive(
    edrpous: list[str] | None = None,
    archive_name: str = DEFAULT_ARCHIVE_NAME,
    output_dir: Path = DEFAULT_OUTPUT_DIR,
    concurrency: int = DEFAULT_CONCURRENCY,
) -> Path:
    requested_edrpous = edrpous or DEFAULT_EDRPOUS
    ...
    try:
        ...
        tasks = [_render_report(client, semaphore, item) for item in items]
